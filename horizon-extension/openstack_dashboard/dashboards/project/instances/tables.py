...
class ConfigureInstance(tables.LinkAction):
    '''
    Configuration table option, used to configure the VNFs
    '''
    name = "configure"
    verbose_name = _("Configure Instance")
    url = "horizon:project:instances:configuration"
...
class InstancesTable(tables.DataTable):
    ...
    class Meta:
        ...
        row_actions = (StartInstance, ConfigureInstance, ConfirmResize,
                       RevertResize,
