...
class AddView(forms.ModalFormView):
    ...
    def get_context_data(self,**kwargs):
        ...
        :return:
        """
        LOG.info("get_context_data get_context_data --")  
        LOG.info("self.success_url: "+str(self.success_url))
        LOG.info("self.submit_url: "+str(self.submit_url))      
    ...
    def get_initial(self):
        ...
        :return:
        """
        LOG.info("get_initial get_initial --")
        LOG.info("self.kwargs: "+str(self.kwargs))
        LOG.info("self.success_url: "+str(self.success_url))
        LOG.info("self.submit_url: "+str(self.submit_url))
